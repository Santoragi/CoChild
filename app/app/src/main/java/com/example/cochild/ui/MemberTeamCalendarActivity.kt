...
class MemberTeamCalendarActivity : MemberBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_member_team_calendar)


        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.member_calendar)) { v, insets ->
        ...
        // 캘린더 객체
        val calendar = findViewById<CalendarView>(R.id.member_calendarView)
...
//    }
    ...
    private fun todayNotice() {
        ...
        if (filteredNotices.isNotEmpty()) {
            ...
            noticeContent.text = "선택한 날짜에 공지사항이 없습니다."
        }
    ...
    private fun goIntoNotice(notices: List<Notice>) {
        ...
        goIntoNoticeButton.setOnClickListener {
            ...
            val intent = Intent(this, MemberReadNoticeActivity::class.java).apply {
