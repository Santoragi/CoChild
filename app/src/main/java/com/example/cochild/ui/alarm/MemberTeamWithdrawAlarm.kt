...
class MemberTeamWithdrawAlarm(private val context: Context) {

    fun show() {
        // dialog_member_team_withdraw.xml 레이아웃을 인플레이트하여 다이얼로그 뷰로 설정
        val dialogView = LayoutInflater.from(context).inflate(R.layout.dialog_member_team_withdraw, null)
