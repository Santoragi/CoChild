...
import com.example.cochild.AdminCreatePostActivity
import com.example.cochild.R
import com.example.cochild.TeamPostListAdapter
import com.example.cochild.models.Team
import com.example.cochild.models.User

import com.example.cochild.MemberCreatePostActivity
...
class MemberTeamBoardActivity: MemberBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_member_team_board)

        // 시스템 바를 처리하여 엣지 투 엣지 모드 적용
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.member_team_board)) { v, insets ->
        ...
        getTeam(teamId) { team ->
            if (team != null) {
                ...
                addPost.setOnClickListener {
                    val intent = Intent(this, MemberCreatePostActivity::class.java)
