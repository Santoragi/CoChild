...
import com.example.cochild.AdminCreateNoticeActivity
import com.example.cochild.AdminCreatePostActivity
import com.example.cochild.R
import com.example.cochild.TeamNoticeListAdapter
...
class MemberTeamNoticeActivity: MemberBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_member_team_notice)
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.member_team_notice)) { v, insets ->
