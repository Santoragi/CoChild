                    ...
                    getUser(userId) { user ->
                        if (user != null) {
                            ...
                            getTeam(teamId) { teamName ->
                                ...
                                val teamInfo = mapOf(
                                    "teamId" to teamId,
                                    "teamName" to teamName // 팀 이름을 추가 (teamName 변수로 정의)
                                )
                                ...
                                FirebaseFirestore.getInstance().collection("Users").document(userId)
                                    ...
                                    .addOnSuccessListener {
                                        ...
                                        Log.d(
                                            "RequestAdapter",
                                            "User $userId added to team $teamId with name $teamName"
                                        )
                                    ...
                                    .addOnFailureListener { e ->
                                        Toast.makeText(
                                            holder.itemView.context,
                                            "사용자 팀 정보 업데이트에 실패했습니다: ${e.message}",
                                            Toast.LENGTH_SHORT
                                        ).show()
                                    }
                            }
