...
class AdminTeamHomeActivity : AdminBaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_admin_team_home)

        // Window Insets 설정
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.admin_team_home)) { v, insets ->
        ...
        // 수정 버튼 클릭 시 TeamCreateActivity로 이동
        findViewById<Button>(R.id.edit_button).setOnClickListener {
            val intent = Intent(this, TeamCreateActivity::class.java)
    ...
    private fun loadMemberData(memberIds: List<String>) {
        ...
        firestore.collection("Users")
            ...
            .addOnSuccessListener { documents ->
                ...
                adminProfileAdapter.updateMembers(members)
    ...
    private fun loadImageFromUrl(url: String?, imageView: ImageView) {
        if (url.isNullOrEmpty()) {
            ...
            Log.e("AdminTeamHomeActivity", "URL이 비어 있습니다.")
            return
        }
